...
var creatorList = ['@RahmadGanz','@alpha'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'RahmadGanz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'RahmadGanz) return res.json(loghandler.invalidKey)
...
router.get('/randomquote', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'rahmadgans') return res.json(loghandler.invalidKey)
